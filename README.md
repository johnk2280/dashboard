...
5. Реализован функционал проверки истечения срока поставки. В случае, если срок прошел, отправляется сообщение в Telegram.
6. Реализовано одностраничное web-приложение на основе Django. Front-end - шаблонизатор Django.
